 ...
 * @author ntu-user
 */
public class ConvertedGroupChatDetailsObjectFromJSON implements IReadJSONFileAndConvertIntoObject{
    ...
    public Object convertJSONToObject(String fileName) {
        ...
        GroupChatDetailsList ben;
        String pathName = "src/main/resources/com/mycompany/chatapplication/" + fileName + ".json";
        try {
           
            ben = objectMapper.readValue(new File(pathName), GroupChatDetailsList.class);
    ...
    public Boolean writeObjectToJSON(List<Object> obj, String fileName) {
          ObjectMapper objectMapper = new ObjectMapper();
        GroupChatDetailsList ben = new GroupChatDetailsList();
        String pathName = "src/main/resources/com/mycompany/chatapplication/" + fileName + ".json";
        for(int i=0; i< obj.size();i++){         
            ben.GroupChatDetailsList.add((GroupChat)obj.get(i));
        }
        try {
